...
[B,BINT,R,RINT,stats] = regress(AQ,[advice_taking(:,10) ones(size(mltm_par,1),1)]);
disp(['GLM with going with AQ as the dependent variable and advice-taking in volatile phases:'...
' p value  ' ...
num2str(stats(3))]);
